    ...
    sections: [
        ...
        */
        ...
        /* ----- Other Works（3カテゴリ） ----- */
        {
            ...
            intro: "AI制作だけでなく、幅広いアウトプットにも対応しています。現在はAI広告制作にフォーカスしていますが、UI/UX、モーショングラフィックス、システム設計なども行っています。",
